...
import { SearchIcon, PlusIcon, EditIcon, TrashIcon, TrophyIcon, StarIcon, GoalIcon, InstagramIcon } from "lucide-react"; // Importar TrophyIcon e GoalIcon
...
export default function RegisteredPlayersTab() {
            ...
            <Card key={player.id} className="relative flex flex-col">
              ...
              <CardContent className="flex-grow flex flex-col justify-between">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-muted-foreground flex items-center gap-1"><InstagramIcon className="h-4 w-4" /> Instagram:</span>
                    {player.instagram ? (
                      <a href={`https://instagram.com/${player.instagram.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="font-medium text-primary hover:underline">
                  ...
                  <div className="flex items-center justify-between mt-2 text-sm">
                    ...
                    <div className="flex items-center gap-1 font-bold">
                      ...
                      <span>{player.total_goals || 0}</span>
                    </div>
                  </div>
                </div>
                <div className="flex justify-end gap-2 mt-4">
                  ...
                  {isAdmin && ( // Apenas administradores podem excluir
                    <Tooltip>
                      <TooltipTrigger asChild>
