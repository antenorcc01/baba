...
import { SearchIcon, PlusIcon, EditIcon, TrashIcon, UserPlus, TrophyIcon, StarIcon, GoalIcon } from "lucide-react"; // Importar TrophyIcon e GoalIcon
import { supabase } from "@/integrations/supabase/client";
import { showSuccess, showError } from "@/utils/toast";
import GuestPlayerForm, { GuestPlayerFormData, GuestPlayer } from "@/components/players/GuestPlayerForm";
import { useAuth } from "@/contexts/AuthContext";
import ConvertGuestDialog from "@/components/admin/ConvertGuestDialog";
...
export default function GuestPlayersTab() {
